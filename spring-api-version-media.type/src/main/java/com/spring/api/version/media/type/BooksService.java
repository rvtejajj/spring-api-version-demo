...
public class BooksService {
    ...
    private final List<Book> BOOKS = List.of(
            new Book(5L,"978-0-14-028005-1", "The Great Gatsby", "F. Scott Fitzgerald"),
    ...
    public Book getDesireBook(Book book) {
      return BOOKS.stream().filter(b->b.getId().equals(book.getId()) && b.getIsbn().equals(book.getIsbn())).findFirst().orElse(book);
    }
}
